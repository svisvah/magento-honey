...
return [
    'modules' => [
        ...
        'OrderAttribute_DeliveryNote' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Temando_ShippingRemover' => 1,
        'V4U_OwlCarousel' => 1,
        'Vendor_AdminLogo' => 1,
        'Vendor_AdminProductAlert' => 1,
        'Vendor_Contactus' => 1,
        'Vendor_GuestOrderLink' => 1,
        'Vendor_LayeredNavigation' => 1,
        'Vendor_MagentoWishlist' => 1,
        'Vendor_Outlet' => 1,
        'Vendor_RelatedProducts' => 1,
        'WholesaleCustomer_ApproveAPI' => 1,
        'WholesaleCustomer_ApproveLog' => 1,
        'WholesaleCustomer_ApproveLogTable' => 1,
        'WholesaleCustomer_LoginRestriction' => 1,
        'WholesaleCustomer_PendingApprovalCron' => 1,
