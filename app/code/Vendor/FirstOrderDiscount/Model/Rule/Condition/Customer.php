...
namespace Vendor\FirstOrderDiscount\Model\Rule\Condition;
...
class Customer extends \Magento\Rule\Model\Condition\AbstractCondition
{
    ...
    $objectmanager->get('Psr\Log\LoggerInterface')->info('First Order Discount Validate Function'); //Print log in var/log/system.log
    $objectmanager->get('Psr\Log\LoggerInterface')->debug('First Order Discount Validate Function');
